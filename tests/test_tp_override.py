...
from tests.mocks import MockIGClient, MockGeminiAnalyst, MockNewsFetcher, MockTradeLoggerDB, MockTradeMonitorDB, MockStreamManager
...
def test_tp_overridden_when_trailing_stop():
    ...
    assert call_args['limit_level'] is None, "limit_level should be None when use_trailing_stop is True"
...
def test_tp_preserved_when_no_trailing_stop():
    ...
    assert call_args['limit_level'] == 7600.0, "limit_level should match take_profit when use_trailing_stop is False"
